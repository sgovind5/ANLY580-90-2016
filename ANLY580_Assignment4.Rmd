...
The "Plotly" package is used to translate ggplot2 graphs to an interactive web-based version and/or create custom web-based visualizations directly from R. The "Diamonds" dataset contains the prices and other attributes such as carat, quality, color, clariyt etc. of almost 54,000 diamonds.The blow chart is an interactive R plot the shows the variation in diamond price and carat, weight of diamond.
